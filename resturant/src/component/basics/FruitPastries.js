...
import latte from '../../assets/images/fruitcake.jpg'
import {useSelector, useDispatch} from 'react-redux';
import {incre, decre} from '../../actions/index';
import reviewimg from '../../assets/review.png';

export default function FruitPastries() { 
            ...
            <div className='container-fluid body-one'>
                ...
                <div className='smooth'>
                    ...
                    <div className='row'>
                        ...
                        <hr/>
                        <p>price : <span className='price'>{menu[18].price}</span></p>
