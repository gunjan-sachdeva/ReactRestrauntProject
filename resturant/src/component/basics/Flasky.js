...
import latte from '../../assets/images/laminated pastry.jpg'
import {useSelector, useDispatch} from 'react-redux';
import {incre, decre} from '../../actions/index';
import reviewimg from '../../assets/review.png';

export default function Flasky() { 
            ...
            <div className='container-fluid body-one'>
                ...
                <div className='smooth'>
                    ...
                    <div className='row'>
                        ...
                        <hr/>
                        <p>price : <span className='price'>{menu[14].price}</span></p>
